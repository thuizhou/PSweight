# Binary ATE with ps value supplied



ATEbin_p <- function(ps.formula,ps.estimate=NULL,zname=NULL,yname,data,trtgrp=NULL,augmentation=FALSE,out.formula=NULL,out.estimate=NULL,bootstrap=FALSE, R=200, family=NULL,delta=0){
